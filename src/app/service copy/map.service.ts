...
export class MapService {
  ...
  initMap(containerId: string, center: [number, number], zoom: number, initialMarkers?: MarkerData[]) {
  ...
  addMarkerWithPopup(coordinates: maplibregl.LngLatLike, properties: any): maplibregl.Marker {
    ...
    popupContent.addEventListener('mouseenter', () => clearTimeout(hideTimeout));
