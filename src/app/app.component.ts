    ...
    const map = new maplibre.Map(
      ...
      // ldskj
        [
          ...
          //   'source-layer': 'place', 
          //   layout: {
          //     'text-field': ['get', 'name'], // 👈 Bangla label field
          //     'text-font': ['Noto Sans Bengali Regular'], // 👈 Must match a valid font!
          //     'text-size': 14
          //   },
          //   paint: {
          //     'text-color': '#111',
          ...
          // },
          {
            ...
            'type': 'fill',
            'source': 'vector-tiles',
            'source-layer': 'waterway',  // Replace with the actual source layer name
            'paint': {
              "fill-color": "hsl(205, 56%, 73%)",
            }
          },
